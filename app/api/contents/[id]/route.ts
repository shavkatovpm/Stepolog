...
export async function PUT(req: Request, { params }: { params: Promise<{ id: string }> }) {
  ...
  const fields = ["title", "publishDate", "status", "note", "keyword", "keywords2", "internalLink", "intent", "source", "facts", "ctaTarget", "brandCount", "mainQuestion", "blogTopics", "contentText", "contentType"];
